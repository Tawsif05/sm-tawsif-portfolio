...
const info = [
  {
    icon: <FaPhoneAlt />,
    title: "Phone",
    description: "(+88) 01639138880",
  },
  {
    icon: <FaEnvelope />,
    title: "Email",
    description: "tawsif0720@gmail.com",
  },
  {
    icon: <FaMapMarkerAlt />,
    title: "Address",
          ...
          <div className="xl:w-[54%] order-2 xl:order-none">
            <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
              ...
              <p className="text-white/60">
                Together, we can create something amazing. Let&rsquo;s start
                today!
              </p>
              {/* input */}
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectGroup>
                    ...
                    <SelectItem value="mst">Mern Stack Development</SelectItem>
                  </SelectGroup>
                </SelectContent>
              </Select>
              {/* textarea */}
